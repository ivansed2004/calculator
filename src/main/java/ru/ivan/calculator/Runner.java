package ru.ivan.calculator;

import ru.ivan.calculator.builders.HyperbolaExpressionBuilder;
import ru.ivan.calculator.builders.InterferogramExpressionBuilder;
import ru.ivan.calculator.objects.Hyperbola;
import ru.ivan.calculator.objects.interferogram.Interferogram;
import ru.ivan.calculator.objects.spline.SplineBasedFunction;
import ru.ivan.calculator.objects.spline.SplineEquationResolver;
import ru.ivan.calculator.persisters.HyperbolaPersister;
import ru.ivan.calculator.persisters.InterferogramPersister;
import ru.ivan.calculator.persisters.SplinePersister;
import ru.ivan.calculator.printers.HyperbolaPrinter;
import ru.ivan.calculator.printers.InterferogramPrinter;
import ru.ivan.calculator.samplers.HyperbolaSampler;
import ru.ivan.calculator.samplers.InterferogramSampler;
import ru.ivan.calculator.samplers.SplineSampler;
...
import static ru.ivan.calculator.environment.Environment.*;
